...
path1='D:/BaiduNetdiskDownload/Drone-detection-dataset-master/Data/image/'#生成的所有图片的路径
all_img_num=4#图片名字的位数，五位数例如：00001.jpg
def readtest():
    videoname = 'D:/BaiduNetdiskDownload/Drone-detection-dataset-master/Data/Video_V/..'#视频的名字
